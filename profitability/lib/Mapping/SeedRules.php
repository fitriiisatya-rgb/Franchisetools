...
/**
 * Ported 1:1 from src/lib/mapping/seedRules.ts. Specific literal labels from
 * the pilot P&L sheet come first (low priority number = matched first) so
 * the exact source wording maps precisely. Generic keyword rules follow so
 * future uploads with different-but-similar wording still auto-classify
 * without manual work.
 */
final class SeedRules
{
    public static function all(): array
    {
        return [
            // ---- REVENUE (leaf components only) ----
